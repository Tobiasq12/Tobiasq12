...
function MainScript:SetupAssets()
    ...
    GameSound.Load("HALLOWEEN_SPOOKY_WIND_01")
    GameSound.Load("CARWASH_SOUNDS")
...
function MainScript:RegisterVars()
    ...
    VORTEX_PARTICLE_NAME = "ent_ray_fam3_dust_linger"
    VORTEX_PARTICLE_ASSET = "des_stilthouse"
    VORTEX_PARTICLE_MOD = true
    VORTEX_GIRTH_MOD = 32.0
